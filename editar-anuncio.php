...
<div class="container">   
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="addFoto">Fotos do anúncio</label>
            <input type="file" name="fotos[]" id="addFoto" multiple/>            
        </div>
        
        <br>
        
        <div class="card">
            <div class="card-header">Fotos do Anuncio</div>
                ...
                <div class="card-body">
                    ...
                    <div class="foto_item">
                        ...
                        <a href="excluir-foto.php?id=<?php echo $foto['id'];?>"
                           class="btn btn-secondary">Excluir imagem</a>
                    </div>
